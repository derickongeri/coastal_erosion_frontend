...
class Formatter {
    ...
    FormatContainerCompactMultiline(item, depth, includeTrailingComma) {
        ...
        this._buffer.Add(this._pads.EOL, this.Options.PrefixString, this._pads.Indent(depthAfterColon), this._pads.End(item.Type, BracketPaddingType_1.BracketPaddingType.Empty));
    ...
    FormatContainerTable(item, depth, includeTrailingComma) {
        ...
        if (!template.TryToFit(availableSpace))
            return false;
        const depthAfterColon = this.StandardFormatStart(item, depth);
        this._buffer.Add(this._pads.Start(item.Type, BracketPaddingType_1.BracketPaddingType.Empty), this._pads.EOL);
